...
class ShoesController extends Controller
{
    ...
    public function viewAction($id){
        ...
        $this->view->title_for_page = $this->view->shoes->name.' '.$this->view->shoes->price.'грн. в Днепропетровск, цена — купить в интернет-магазине RUMI';
        ...
        $this->view->meta_description = $this->view->shoes->name.' '.$this->view->shoes->price.'грн. по лучшей цене в Днепропетровске. Огромный выбор обуви ждет Вас в интернет-магазине RUMI. Доставка по всей Украине. Оформите заказ онлайн прямо сейчас!';
